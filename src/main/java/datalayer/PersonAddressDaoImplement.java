...
public class PersonAddressDaoImplement extends DBAbstructInfo implements PersonAddressDao {
	...
	public void setAddress(float personID,String address1,String address2,String city,int zipCode,String region,String country) throws ClassNotFoundException, SQLException {
		PreparedStatement insertQuery =   executeTheQuerty("INSERT INTO defaultaddress (personID,address1,address2,city,zipCode,region,country) values (?,?,?,?,?,?,?)");
	...
	public  void ModidyAddressOnePerson(int id ,String addressOne) throws ClassNotFoundException, SQLException {
		PreparedStatement insertQuery =   executeTheQuerty("UPDATE defaultaddress SET address1= ? where personID = ? )");
	...
	public  void ModidyAddressTwoPerson(int id ,String addressTwo) throws ClassNotFoundException, SQLException {
		PreparedStatement insertQuery =   executeTheQuerty("UPDATE defaultaddress SET address2= ? where personID = ? )");
	...
	public  void ModidyZipCodePerson(int id ,int zip) throws ClassNotFoundException, SQLException {
		PreparedStatement insertQuery =   executeTheQuerty("UPDATE defaultaddress SET zipcode = ? where personID = ? )");
	...
	public  void ModidyRegionPerson(int id ,String region) throws ClassNotFoundException, SQLException {
		PreparedStatement insertQuery =   executeTheQuerty("UPDATE defaultaddress SET region = ? where personID = ? )");
	...
	public  void ModidyCityPerson(int id ,String city) throws ClassNotFoundException, SQLException {
		PreparedStatement insertQuery =   executeTheQuerty("UPDATE defaultaddress SET city= ? where personID = ? )");
	...
	public  void ModidyConutryPerson(int id ,String country) throws ClassNotFoundException, SQLException {
		PreparedStatement insertQuery =   executeTheQuerty("UPDATE defaultaddress SET country= ? where personID = ? )");
