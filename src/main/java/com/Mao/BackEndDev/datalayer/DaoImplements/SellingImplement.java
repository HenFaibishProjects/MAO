...
//	}
//	
//	public void addSale(Date sellDate, int quantityPurchase, String barCode,float pricePurchaseItems,int empId){
//		Items item = getUniqueObjectResultByBarCode(barCode);
//		saleItems = new SaleItems(sellDate, quantityPurchase, item, pricePurchaseItems,empId);
...
//		Items item = getUniqueObjectResultByBarCode(barCode);
//		saleItems = new SaleItems(sellDate, quantityPurchase, item, pricePurchaseItems,2);
//		stock = getUniqueObjectStockResultByItemId(barCode);
//		stock.setItems(item);
//		stock.setCurrentMarketPrice(pricePurchaseItems);
//		stock.setQuantity(stock.getQuantity()-quantityPurchase);
